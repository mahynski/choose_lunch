...
def main():
    ...
    parser.add_argument('-v', '--visited', dest='histogram',
                        default=VISITED, type=str,
                        help='Histogram of visited restaurants (default: %(default)s)')
    parser.add_argument('-m', '--max', dest='limit',
    ...
    try:
        query_api(input_values.term, input_values.location, input_values.histogram, input_values.limit)
